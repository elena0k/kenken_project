...
public class TemplateKenken {
    ...
    public static List<Gruppo> templateGroupsOneSolution() {
        ...
        l1.add(allCoord.get(0));
        l1.add(allCoord.get(1));
        l2.add(allCoord.get(2));
        l2.add(allCoord.get(5));
        l3.add(allCoord.get(3));
        l3.add(allCoord.get(4));
        l3.add(allCoord.get(6));
        l4.add(allCoord.get(7));
        l4.add(allCoord.get(8));
    ...
    public static List<Gruppo> templateGroupsNOSolution() {
        ...
        l1.add(allCoord.get(0));
        l1.add(allCoord.get(1));
        l1.add(allCoord.get(3));
        l2.add(allCoord.get(2));
        l2.add(allCoord.get(5));
        l2.add(allCoord.get(8));
        l3.add(allCoord.get(4));
        l3.add(allCoord.get(6));
        l3.add(allCoord.get(7));
    ...
    public static List<Gruppo> templateManySolution() {
        ...
        l1.add(allCoord.get(0));
        l1.add(allCoord.get(1));
        l1.add(allCoord.get(2));
        l1.add(allCoord.get(3));
        l1.add(allCoord.get(4));
        l1.add(allCoord.get(5));
        l1.add(allCoord.get(6));
        l1.add(allCoord.get(7));
        l1.add(allCoord.get(8));
